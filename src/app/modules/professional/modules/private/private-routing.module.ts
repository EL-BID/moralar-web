...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'matchs',
        loadChildren: () => import('src/app/modules/professional/modules/private/modules/properties/modules/matchs/matchs.module').then(m => m.MatchsModule)
      },
      {
        path: 'displacement-maps',
        loadChildren: () => import('src/app/modules/professional/modules/private/modules/properties/modules/displacement-maps/displacement-maps.module').then(m => m.DisplacementMapsModule)
      },
      {
        path: 'videos',
        loadChildren: () => import('src/app/modules/professional/modules/private/modules/videos/videos.module').then(m => m.VideosModule)
      },
      {
        path: 'questionarios',
      ...
      {
        path: 'notificacoes',
        loadChildren: () => import('src/app/modules/professional/modules/private/modules/notifications/notifications.module').then(m => m.NotificationsModule)
      },
      {
        path: 'perfis',
